...
class AdaptiveGridConfig:
    ...
    def __post_init__(self):
        ...
        if self.base_grid is None:
            ...
            self.base_grid = GridConfig(
                ...
                * 0.4
                / 16,  # 40% of capital, 16 total orders
            )
        ...
        if self.enhanced_grid is None:
            ...
            self.enhanced_grid = GridConfig(
                ...
                order_size=self.total_capital
                * 0.6
                / 20,  # 60% of capital, 20 total orders
            )
    ...
    def get_optimal_grid_spacing(self, grid_type: str = "base") -> float:
        # Hardcoded thresholds removed - will use dynamic volatility scaling
        # This method will be replaced by VolatilityOrderSizer
        base_spacing = Config.BASE_GRID_SPACING
        return base_spacing  # Temporary - will be replaced by advanced feature
    ...
    def _calculate_risk_score(self) -> float:
        ...
        allocation_risk = allocation[
            "enhanced_allocation"
        ]  # Higher enhanced = higher risk
