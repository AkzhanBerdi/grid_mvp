...
Ready to experience smart trading?"""
        ...
        keyboard = [
            [InlineKeyboardButton("🚀 Start Smart Trading", callback_data="setup_smart_trading")],
            [InlineKeyboardButton("🔐 Setup API Keys", callback_data="setup_api")],
            [InlineKeyboardButton("📊 Learn More", callback_data="learn_smart_trading")],
        ]
    ...
    async def _show_smart_dashboard(self, update, client):
        ...
        performance = await self.grid_orchestrator.get_client_performance(client.telegram_id)
        ...
        for symbol, perf in performance.get("adaptive_performance", {}).items():
            market_condition = perf.get("market_condition", {}).get("condition", "neutral")
            enhanced_active = "✅" if perf.get("enhanced_grid_active") else "⚪"
            adaptive_summary.append(f"{symbol}: {market_condition.title()} {enhanced_active}")
...
**Quick Trading:** Type `ADA 1000` or `AVAX 500`"""
        ...
        if client.can_start_grid():
            if active_grids > 0:
                keyboard.append([
                    InlineKeyboardButton("🛑 Stop All Grids", callback_data="stop_all_grids")
                ])
                keyboard.append([
                    InlineKeyboardButton("🎯 Optimize Grids", callback_data="optimize_grids")
                ])
            else:
                keyboard.append([
                    InlineKeyboardButton("🚀 Start Smart Trading", callback_data="start_smart_trading")
                ])
        
        keyboard.extend([
            [
                InlineKeyboardButton("📊 Smart Performance", callback_data="show_smart_performance"),
                InlineKeyboardButton("🌍 Market Overview", callback_data="show_market_overview")
            ],
            [
                InlineKeyboardButton("⚙️ Settings", callback_data="show_settings"),
                InlineKeyboardButton("🧠 Trading Insights", callback_data="show_insights")
            ]
        ])
...
Ready to experience the future of grid trading?"""
        ...
        keyboard = [
            [InlineKeyboardButton("🚀 Start Setup", callback_data="setup_smart_trading")],
            [InlineKeyboardButton("🔙 Back", callback_data="show_dashboard")]
        ]
        ...
        if not client.can_start_grid():
            await query.edit_message_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("⚙️ Setup", callback_data="setup_smart_trading")]
                ])
            )
            return
...
Ready to launch?"""
        ...
        keyboard = [
            [InlineKeyboardButton("🚀 LAUNCH SMART TRADING", callback_data="confirm_smart_start")],
    ...
    async def _confirm_smart_start(self, query, client_id):
        ...
        try:
            ...
            for pair in client.trading_pairs:
                ...
                self.logger.info(f"Starting smart grid for {pair} with ${capital_per_pair:.2f}")
            ...
            if successful_grids == len(client.trading_pairs):
                ...
                for res in results:
                    if res["success"]:
                        ...
                        total_enhanced_orders += res["result"].get("enhanced_grid_orders", 0)
...
"""
                ...
                for res in results:
                    if res["success"]:
                        ...
                        market_condition = result_data.get("market_condition", "neutral")
...
• Optimize for maximum profits!"""
                ...
                keyboard = [
                    [InlineKeyboardButton("📊 Smart Dashboard", callback_data="show_dashboard")],
                    [InlineKeyboardButton("🧠 View Insights", callback_data="show_insights")],
                    [InlineKeyboardButton("🌍 Market Overview", callback_data="show_market_overview")]
                ]
...
Please check your API permissions and account balance for failed pairs."""
                ...
                keyboard = [
                    ...
                    [InlineKeyboardButton("🔄 Retry Failed", callback_data="start_smart_trading")]
                ]
...
• Market conditions"""
                ...
                keyboard = [
                    [InlineKeyboardButton("🔄 Try Again", callback_data="start_smart_trading")],
            ...
            self.logger.error(f"Error in smart trading launch for client {client_id}: {e}")
...
**🎯 Active Smart Grids:**"""
            ...
            keyboard = [
                [InlineKeyboardButton("🔄 Refresh", callback_data="show_smart_performance")],
            ...
            await query.edit_message_text(
                ...
                "Please try again or contact support.",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔄 Try Again", callback_data="show_smart_performance")],
                    [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
                ])
            )
...
**📈 Market Conditions:**"""
            ...
            keyboard = [
                [InlineKeyboardButton("🔄 Refresh", callback_data="show_market_overview")],
                [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
            ]
            ...
            await query.edit_message_text(
                ...
                "Please try again or contact support.",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔄 Try Again", callback_data="show_market_overview")],
                    [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
                ])
            )
...
**📊 Insight Summary:**"""
            ...
            keyboard = [
                [InlineKeyboardButton("🎯 Optimize Now", callback_data="optimize_grids")],
                [InlineKeyboardButton("📊 Performance", callback_data="show_smart_performance")],
                [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
            ]
            ...
            await query.edit_message_text(
                ...
                "Please try again or contact support.",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔄 Try Again", callback_data="show_insights")],
                    [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
                ])
            )
    ...
    async def _optimize_grids(self, query, client_id):
        ...
        try:
            ...
            keyboard = [
                [InlineKeyboardButton("📊 View Performance", callback_data="show_smart_performance")],
                [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
            ]
            ...
            await query.edit_message_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔄 Try Again", callback_data="optimize_grids")],
                    [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
                ])
            )
...
Please check manually or contact support."""
        ...
        keyboard = [
            [InlineKeyboardButton("🚀 Restart Smart Trading", callback_data="start_smart_trading")],
            [InlineKeyboardButton("📊 Dashboard", callback_data="show_dashboard")]
        ]
...
Please check your account and try again."""
    ...
    async def handle_message(self, update, context):
        ...
        # Handle API setup flow (reuse existing logic)
...
Ready to launch intelligent trading?"""
            ...
            keyboard = [
                [InlineKeyboardButton("🚀 LAUNCH SMART GRID", callback_data=f"execute_trade_{symbol}_{amount}")],
                [InlineKeyboardButton("❌ Cancel", callback_data="show_dashboard")]
            ]
