...
from services.dual_scale_grid_manager import (
    DualScaleGridManager as SmartAdaptiveGridManager,
)
from services.market_analysis import MarketAnalysisService
from utils.crypto import CryptoUtils


class EnhancedGridOrchestrator:
    ...
    def __init__(self):
        ...
        self.adaptive_managers: Dict[int, SmartAdaptiveGridManager] = {}
    ...
    async def start_client_grid(
        ...
        try:
            ...
            if client_id not in self.adaptive_managers:
                self.adaptive_managers[client_id] = SmartAdaptiveGridManager(
